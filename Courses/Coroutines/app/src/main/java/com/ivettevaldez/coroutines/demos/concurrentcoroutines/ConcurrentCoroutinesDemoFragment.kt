package com.ivettevaldez.coroutines.demos.concurrentcoroutines
...
class ConcurrentCoroutinesDemoFragment : BaseFragment() {
    ...
    override val screenTitle: String
        get() = ScreenReachableFromHome.CONCURRENT_COROUTINES_DEMO.description
    ...
    companion object {
        ...
        fun newInstance() = ConcurrentCoroutinesDemoFragment()
    }
