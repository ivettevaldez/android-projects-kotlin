...
class DesignDemoFragment : BaseFragment() {
    ...
    override val screenTitle: String
        get() = ScreenReachableFromHome.SCOPE_CANCELLATION_DEMO.description
    ...
    companion object {
        ...
        fun newInstance() = DesignDemoFragment()
    }
    ...
    override fun onCreateView(
        ...
        btnStart.setOnClickListener {
            ...
            coroutineScope.launch {
                ...
                val iterationsCount = benchmarkUseCase.executeBenchmark(BENCHMARK_DURATION_SECONDS)
