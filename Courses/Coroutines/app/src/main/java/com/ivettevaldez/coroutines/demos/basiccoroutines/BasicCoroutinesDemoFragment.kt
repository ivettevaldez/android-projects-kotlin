package com.ivettevaldez.coroutines.demos.basiccoroutines
...
class BasicCoroutinesDemoFragment : BaseFragment() {
    ...
    override val screenTitle: String
        get() = ScreenReachableFromHome.BASIC_COROUTINES_DEMO.description
    ...
    companion object {
        ...
        fun newInstance() = BasicCoroutinesDemoFragment()
    }
