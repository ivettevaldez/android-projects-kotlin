...
class CoroutinesCancellationCooperativeDemoFragment : BaseFragment() {
    ...
    override val screenTitle: String
        get() = ScreenReachableFromHome.COROUTINES_CANCELLATION_COOPERATIVE_DEMO.description
    ...
    companion object {
        ...
        fun newInstance() = CoroutinesCancellationCooperativeDemoFragment()
    }
