...
enum class ScreenReachableFromHome(val description: String) {
    ...
    VIEW_MODEL_DEMO("ViewModel"),
    EXERCISE_4("Exercise 4"),
    DESIGN_DEMO("Design Demo"),
    EXERCISE_5("Exercise 5"),
    COROUTINES_CANCELLATION_COOPERATIVE_DEMO("Cancellation Cooperative"),
    COROUTINES_CANCELLATION_COOPERATIVE_2_DEMO("Cancellation Cooperative 2"),
}